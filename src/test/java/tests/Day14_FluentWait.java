...
public class Day14_FluentWait extends TestBase {
    ...
    public void fluentWaitTest(){
        ...
        Wait<WebDriver> wait = new FluentWait<>(driver).
                ...
                pollingEvery(Duration.ofSeconds(2)). //How often will be element checked
                withMessage("Ignoring No Such Element Exception"). // Optional : Give Message
                ignoring(NoSuchElementException.class); // Optional : Ignore Excpetion
...
/*
Implicit wait handle minor issues.
Explicit wait is local wait and more general/global. Works better.
 */
